...
const PeopleType = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    name_kanji: { type: GraphQLString, description: "The name (kanji) of the person" },
    stub: { type: GraphQLString, description: "The stub of the person" },
    uniqid: { type: GraphQLString, description: "The uniqid of the person" },
    description: { type: GraphQLString, description: "Person's biography/comments" },
    ...
    people_works: { type: new GraphQLList(PeopleWorksType), description: "The works of the person" },
  })
});
